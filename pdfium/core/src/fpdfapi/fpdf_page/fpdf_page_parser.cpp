...
void CPDF_StreamContentParser::Handle_SetFont()
{
	...
	auto name = GetString(1);
	CPDF_Font* pFont;
	pFont = FindFont(name);
	//auto  fontKey = name.c_str();
	//if (font_hm.find(fontKey) != font_hm.end())
	//{
	//	pFont = (font_hm[fontKey]);
	//}
	//else
	//{
	//	pFont = FindFont(name);
	//	font_hm[fontKey] = pFont;
	//}
...
{	
	...
	//zhiyong gank here.
	if (pText->m_PosX < 253 || pText->m_PosX > 543 ||
		pText->m_PosY < 485 || pText->m_PosY > 589)
		;
	else
